...
async def send_for_index(bot, message):
    ...
    if message.from_user.id in Config.ADMINS:
        buttons = [
            [
                InlineKeyboardButton('CH 1 Database File Yes',
                                     callback_data=f'index#accept#{chat_id}#{last_msg_id}#{message.from_user.id}'),
                InlineKeyboardButton('DM 1 Database File Yes',
    ...
    buttons = [
        [
            InlineKeyboardButton('CH 1 Database File Accept Index',
                                 callback_data=f'index#accept#{chat_id}#{last_msg_id}#{message.from_user.id}'),
            InlineKeyboardButton('DM 1 Database File Accept Index',
                                 callback_data=f'pmindex#accept#{chat_id}#{last_msg_id}#{message.from_user.id}')
        ],
        [
